// ============================================================================
// GHOSTTY SHADER: SMEAR CURSOR (ZONDER KLEURVERANDERIGEN / BLOOM)
// ============================================================================
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    // Render de trail zonder extra kleur- of saturatie-aanpassingen
    vec4 trail = mix(TRAIL_COLOR_ACCENT, baseColor, 1. - smoothstep(0., sdfTrail + mod, 0.007));
    ...
    // 2. EINDRESULTAAT
    fragColor = mix(trail, baseColor, 1. - smoothstep(0., sdfCurrentCursor, easedProgress * lineLength));
}
